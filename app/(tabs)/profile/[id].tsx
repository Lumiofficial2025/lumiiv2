...
import { ArrowLeft, Grid3x3, Heart, Settings, Image as ImageIcon } from 'lucide-react-native';
...
export default function UserProfileScreen() {
  ...
  if (!id || typeof id !== 'string' || !UUID_REGEX.test(id)) {
    // If no valid ID, redirect to the user's own profile
      ...
      >
        <View style={styles.profileSection}>
          ...
          {isOwnProfile ? (
            ...
            >
              <Text style={[textStyles.labelMedium, { color: colors.text }]}>Edit Profile</Text>
            </TouchableOpacity>
          ) : (
            <TouchableOpacity
              style={[
